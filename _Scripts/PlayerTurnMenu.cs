...
public class PlayerTurnMenu : MonoBehaviour {
	...
	{
		//Debug.Log ("Inside Add Cards To Hand");
	...
	void OnGUI()
	{
		if (showOptions == true)
		{
			...
			else if(ps != null && playerTurn > 0)
			{
				...
				if (plays > 0f)//need to check if they are on the correct space
				{
					if(GUI.Button(new Rect(Screen.width*1/32,
					                       Screen.height*17/32,
					                       Screen.width*6/32,
		...
		if (showCaptainCard == true) {
			if(GUI.Button(new Rect(Screen.width*14/32,
			                       Screen.height*3/32,
			                       Screen.width*4/32,
			                       Screen.height*12/32), "<size=14><b>" + cards.getCCardTitle(displayCaptainCard) + "</b></size>" 
			              + "\n" + cards.getCCardType(displayCaptainCard) 
			              + "\n\n<i>" + cards.getCCardDescription(displayCaptainCard) + "</i>", buttonstyle))
			{
		...
		if (showCards == true)
		{
			...
			{
				GUI.Box(new Rect(Screen.width*4/32,
				                 Screen.height*3/32,
				                 Screen.width*4/32,
				                 Screen.height*12/32), "\n" + cardDisplaysArray[0]);
			}
			...
			{
				GUI.Box(new Rect(Screen.width*9/32,
				                 Screen.height*3/32,
				                 Screen.width*4/32,
				                 Screen.height*12/32), "\n" + cardDisplaysArray[1]);
			}
			else if(GUI.Button(new Rect(Screen.width*9/32,
			                            Screen.height*3/32,
			                            Screen.width*4/32,
			                            Screen.height*12/32), "<size=14><b>" + cards.getCardTitle(cardsArray[1]) + "</b></size>" 
			                   + "\n" + cards.getCardType(cardsArray[1]) 
			                   + "\n\n<i>" + cards.getCardDescription(cardsArray[1]) + "</i>", buttonstyle))
			{
				showOptions = true;
				showCards = false;
			...
			{
				GUI.Box(new Rect(Screen.width*14/32,
				                 Screen.height*3/32,
				                 Screen.width*4/32,
				                 Screen.height*12/32), "\n" + cardDisplaysArray[2]);
			}
			else if(GUI.Button(new Rect(Screen.width*14/32,
			                            Screen.height*3/32,
			                            Screen.width*4/32,
			                            Screen.height*12/32), "<size=14><b>" + cards.getCardTitle(cardsArray[2]) + "</b></size>" 
			                   + "\n" + cards.getCardType(cardsArray[2]) 
			                   + "\n\n<i>" + cards.getCardDescription(cardsArray[2]) + "</i>", buttonstyle))
			{
				showOptions = true;
				showCards = false;
			...
			{
				GUI.Box(new Rect(Screen.width*19/32,
				                 Screen.height*3/32,
				                 Screen.width*4/32,
				                 Screen.height*12/32), "\n" + cardDisplaysArray[3]);
			}
			else if(GUI.Button(new Rect(Screen.width*19/32,
			                            Screen.height*3/32,
			                            Screen.width*4/32,
			                            Screen.height*12/32), "<size=14><b>" + cards.getCardTitle(cardsArray[3]) + "</b></size>" 
			                   + "\n" + cards.getCardType(cardsArray[3]) 
			                   + "\n\n<i>" + cards.getCardDescription(cardsArray[3]) + "</i>", buttonstyle))
			{
				showOptions = true;
				showCards = false;
			...
			{GUI.Box(makeRect(24,3,4,12), "\n" + cardDisplaysArray[4]);}
			else if(GUI.Button(makeRect(24,3,4,12), "<size=14><b>" + cards.getCardTitle(cardsArray[4]) + "</b></size>" 
			                   + "\n" + cards.getCardType(cardsArray[4]) 
			                   + "\n\n<i>" + cards.getCardDescription(cardsArray[4]) + "</i>", buttonstyle))
			{
				showOptions = true;
				showCards = false;
			...
			{GUI.Box(makeRect(4,17,4,12), "\n" + cardDisplaysArray[5]);}
			else if(GUI.Button(makeRect(4,17,4,12), "<size=14><b>" + cards.getCardTitle(cardsArray[5]) + "</b></size>" 
			                   + "\n" + cards.getCardType(cardsArray[5]) 
			                   + "\n\n<i>" + cards.getCardDescription(cardsArray[5]) + "</i>", buttonstyle))
			{
				showOptions = true;
				showCards = false;
			...
			{GUI.Box(makeRect(9,17,4,12), "\n" + cardDisplaysArray[6]);}
			else if(GUI.Button(makeRect(9,17,4,12), "<size=14><b>" + cards.getCardTitle(cardsArray[6]) + "</b></size>" 
			                   + "\n" + cards.getCardType(cardsArray[6]) 
			                   + "\n\n<i>" + cards.getCardDescription(cardsArray[6]) + "</i>", buttonstyle))
			{
				showOptions = true;
				showCards = false;
			...
			{GUI.Box(makeRect(14,17,4,12), "\n" + cardDisplaysArray[7]);}
			else if(GUI.Button(makeRect(14,17,4,12), "<size=14><b>" + cards.getCardTitle(cardsArray[7]) + "</b></size>" 
			                   + "\n" + cards.getCardType(cardsArray[7]) 
			                   + "\n\n<i>" + cards.getCardDescription(cardsArray[7]) + "</i>", buttonstyle))
			{
				showOptions = true;
				showCards = false;
			...
			{GUI.Box(makeRect(19,17,4,12), "\n" + cardDisplaysArray[8]);}
			else if(GUI.Button(makeRect(19,17,4,12), "<size=14><b>" + cards.getCardTitle(cardsArray[8]) + "</b></size>" 
			                   + "\n" + cards.getCardType(cardsArray[8]) 
			                   + "\n\n<i>" + cards.getCardDescription(cardsArray[8]) + "</i>", buttonstyle))
			{
				showOptions = true;
				showCards = false;
			...
			{GUI.Box(makeRect(24,17,4,12), "\n" + cardDisplaysArray[9]);}
			else if(GUI.Button(makeRect(24,17,4,12), "<size=14><b>" + cards.getCardTitle(cardsArray[9]) + "</b></size>" 
			                   + "\n" + cards.getCardType(cardsArray[9]) 
			                   + "\n\n<i>" + cards.getCardDescription(cardsArray[9]) + "</i>", buttonstyle))
			{
				showOptions = true;
				showChatWindow = true;
				showCards = false;
