...
#define HT_ADD(t, key, val) ht_add(t, (const void*)(key), (void*)(val))
void *ht_add(hashtable_t*, const void*, void*);
#define HT_GET(t, key) ht_get(t, (const void*)(key))
void *ht_get(hashtable_t*, const void*);
#define HT_DELETE(t, key) ht_delete(t, (const void*)(key))
